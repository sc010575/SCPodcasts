...
class MainTabBarController: UITabBarController {
    ...
    func maximizePlayerDetails(episode: Episode?) {
        ...
        UIView.animate(withDuration: 0.5, delay: 0, usingSpringWithDamping: 0.7, initialSpringVelocity: 1, options: .curveEaseOut, animations: {
            ...
            self.playerDetailsView.miximizedStackView.alpha = 1
    ...
    func minimizePlayerDetails() {
        ...
        UIView.animate(withDuration: 0.5, delay: 0, usingSpringWithDamping: 0.7, initialSpringVelocity: 1, options: .curveEaseOut, animations: {
            ...
            self.playerDetailsView.miximizedStackView.alpha = 0
...
fileprivate extension MainTabBarController {
    ...
    func setupTabBarViewControllers() {
        ...
        let favoritesController = FavouritesController(collectionViewLayout: layout)
        viewControllers = [
    ...
    func generateNavigationController(for rootViewController: UIViewController, title: String, image: UIImage, tabState: MainTabBarViewModel.TabState) -> UIViewController {
        ...
        switch tabState {
        case .favorites:
            guard let rootVC = rootViewController as? FavouritesController else { return ViewController() }
